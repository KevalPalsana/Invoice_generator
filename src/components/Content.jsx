...
import { triggerBase64Download,Base64Downloader } from 'react-base64-downloader';
    ...
    <div className="row">
        <div className="col-md-5">
            ...
            <div className="mb-3 ">
                ...
                <input type="number" className="form-control" id="mo_no" name="mo_no" placeholder="xxxxxxxxxx" onChange={onChange2} value={customer.mo_no} />
            </div>
            ...
            <div className="row">
                ...
                <div className="col-sm-4 mt-2">
                    {
                        ok && <button className='btn btn-success' onClick={() => triggerBase64Download(base64, 'Invoice')}>
                        Click to download
                    </button>
                    }
